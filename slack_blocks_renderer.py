...
class TableBlock(Block):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        """
        result = {"type": self.type, "rows": self.rows}
...
class SlackBlocksRenderer(BaseRenderer):
    ...
    def render_heading(self, token) -> str:
        ...
        header_block = HeaderBlock(text=PlainTextObject(text=text_content))
    ...
    def render_paragraph(self, token) -> str:
        ...
        if text_content:
            ...
            section_block = SectionBlock(text=MarkdownTextObject(text=text_content))
    ...
    def render_block_code(self, token) -> str:
        ...
        section_block = SectionBlock(text=MarkdownTextObject(text=formatted_code))
        self.blocks.append(section_block)
        return ""
    ...
    def render_quote(self, token) -> str:
        ...
        if quote_parts:
            ...
            section_block = SectionBlock(text=MarkdownTextObject(text=formatted_quote))
            self.blocks.append(section_block)
        return ""
    ...
    def render_list(self, token) -> str:
        ...
        if list_items:
            ...
            section_block = SectionBlock(text=MarkdownTextObject(text=list_text))
            self.blocks.append(section_block)
    ...
    def _render_table_row_as_cells(self, token) -> list[dict[str, Any]]:
        ...
        for cell in token.children:
            ...
            if len(cells) >= 20:
                break
            cells.append({"type": "raw_text", "text": cell_content or " "})
        return cells
